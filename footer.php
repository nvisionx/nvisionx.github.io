        ...
        <div class="row">
          ...
          <div class="col-sm-6 col-md-4">
            <div class="wow fadeInDown animated" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeInDown;">
              <div class="widget">
                <h5>Our location</h5>
                <p>45, 4th Cross Rd, Huchappa Layout, Govindaraja Nagar Ward, Madhura Nagar, Kottigepalya, Bengaluru, Karnataka 560091</p>
          ...
          <div class="row">
            <div class="col-sm-6 col-md-6 col-lg-6">
              <div class="wow fadeInLeft animated" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeInLeft;">
                <div class="text-left">
                  <p>©Copyright - Arist HealthCare Theme. All rights reserved.</p>
                </div>
              </div>
            </div>
            <div class="col-sm-6 col-md-6 col-lg-6">
              <div class="wow fadeInRight animated" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeInRight;">
                <div class="text-right">
                  <div class="credits">
                    ...
                    -->
                    <a href="http://nvisionx.com/" target="_blank">Designed by <strong>NvisionX</strong></a>
                  </div>
                </div>
              </div>
            </div>
